...
//    
//    @StateObject var observer: Game.Observer
//    
//    public init(_ status: Game.Status) {
//        self._observer = .init(wrappedValue: .init(status: status))
//        self.isNewGame = true
//    }
//    
//    public init(_ game: Game) {
//        self._observer = .init(wrappedValue: .init(game: game))
...
//        .environment(\.editMode, $observer.editMode)
//        .environmentObject(self.observer)
//        .toolbar {
//            
//            //1
//            
...
//        Section {
//            CustomTextField(.title, $observer.title)
//        }
//        Section {
//            CustomDatePicker(.release_date, $observer.release)
//        }
//        
//        Section {
//            Picker(ConstantEnum.property.rawValue, selection: $observer.tagType) {
...
//            .onDelete(action: {
//                $0.forEach { index in
//                    self.observer.delete(systemBuilders[index])
//                }
//            })
//        }
//    }
...
//            .onDelete(action: {
//                $0.forEach { index in
//                    self.observer.delete(systemBuilder, formatEnums[index])
//                }
//            })
//        }
//    }
...
//                .onDelete(action: {
//                    $0.forEach { index in
//                        self.observer.delete(systemBuilder, formatBuilders[index])
//                    }
//                })
//            }, label: {
//                HStack {
